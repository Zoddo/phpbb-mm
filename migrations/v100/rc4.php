...
class rc4 extends \phpbb\db\migration\migration
{
	...
	{
		return array('\zoddo\mm\migrations\v100\rc3');
	}

	public function effectively_installed()
	{
		return isset($this->config['mm_version']) && phpbb_version_compare($this->config['mm_version'], '1.0.0-rc4', '>=');
	}

	public function update_data()
	{
		return array(
			array('config.update', array('mm_version', '1.0.0-rc4')),
		);
	}
}
